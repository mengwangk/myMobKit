...
.controller( 'MediaCtrl', ["$rootScope", "$scope", "Media", "$window", "$timeout", "$uibModal", "$http", "$log", function MediaCtrl($rootScope, $scope, Media, $window, $timeout, $uibModal, $http, $log) {
...
.controller( 'ImageModalCtrl', ["$scope", "$uibModalInstance", "image", function ImageModalCtrl($scope, $uibModalInstance, image) {
		$scope.image = image;
		$scope.close = function () {
			$uibModalInstance.close($scope.image);
		};
}])
.controller( 'VideoModalCtrl', ["$rootScope", "$scope", "$uibModalInstance", "video", function VideoModalCtrl($rootScope, $scope, $uibModalInstance, video) {
		$scope.video = video;

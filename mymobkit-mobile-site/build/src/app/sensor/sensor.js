...
.controller( 'SensorCtrl', ["$rootScope", "$scope", "Messages", "$window", "$timeout", "$http", "$location", "$anchorScroll", function SensorCtrl($rootScope, $scope, Messages, $window, $timeout, $http, $location, $anchorScroll) {

...
.controller( 'ControlPanelCtrl', ["$rootScope", "$scope", "Gcm", "Drive", "GTalk", "Parameter", "$window", "$location", "$timeout", "$uibModal", "$http", "$log", "toaster", function ControlPanelCtrl($rootScope, $scope, Gcm, Drive, GTalk, Parameter, $window, $location, $timeout, $uibModal, $http, $log, toaster) {
...
}]).controller( 'DeviceInfoModalCtrl', ["$rootScope", "$scope", "$uibModalInstance", "deviceInfo", function DeviceInfoModalCtrl($rootScope, $scope, $uibModalInstance, deviceInfo) {
...
}]).controller('ProgressModalCtrl', ["$rootScope", "$scope", "$uibModalInstance", "progressLevel", function ProgressModalCtrl($rootScope, $scope, $uibModalInstance, progressLevel) {
...
}).controller( 'ViewerModalCtrl', ["$rootScope", "$scope", "$window", "$uibModal", "$http", "$location", "$interval", "$localStorage", "$log", "$uibModalInstance", "slides", function ViewerModalCtrl(

...
.controller( 'LocationCtrl', ["$rootScope", "$scope", "Messages", "$window", "$timeout", "$http", "$location", "$anchorScroll", "$log", function LocationCtrl($rootScope, $scope, Messages, $window, $timeout, $http, $location, $anchorScroll, $log) {

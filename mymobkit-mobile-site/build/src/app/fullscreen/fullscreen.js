...
.controller( 'FullScreenCtrl', ["$rootScope", "$scope", "$window", "$timeout", "$http", "$location", "$resource", "$anchorScroll", "$log", function FullScreenCtrl($rootScope, $scope, $window, $timeout, $http, $location, $resource, $anchorScroll, $log) {

...
.controller( 'ContactCtrl', ["$rootScope", "$scope", "Contacts", "$window", "$timeout", "$http", "$location", "$anchorScroll", function ContactCtrl( $rootScope, $scope, Contacts, $window, $timeout, $http, $location, $anchorScroll) {

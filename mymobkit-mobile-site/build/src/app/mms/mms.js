...
.controller( 'MmsCtrl', ["$rootScope", "$scope", "$window", "MMS", "Parameter", "$timeout", "$http", "$location", "$anchorScroll", "$log", function ContactCtrl( $rootScope, $scope, $window, MMS, Parameter, $timeout, $http, $location, $anchorScroll, $log) {

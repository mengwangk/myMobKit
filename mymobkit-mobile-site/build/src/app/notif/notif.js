...
.controller('NotifCtrl', ["$rootScope", "$scope", "Gcm", "$window", "$timeout", "$uibModal", "$http", "$log", function NotifCtrl($rootScope, $scope, Gcm, $window, $timeout, $uibModal, $http, $log) {
		...
		getAllNotifications();
}]).controller( 'NotifModalCtrl', ["$rootScope", "$scope", "$uibModalInstance", "notif", function NotifModalCtrl($rootScope, $scope, $uibModalInstance, notif) {
	$scope.notification = notif;
	$scope.close = function () {
		$uibModalInstance.close($scope.notification);
	};	
}]).controller( 'ConfirmPurgeModalCtrl', ["$rootScope", "$scope", "$uibModalInstance", function ConfirmPurgeModalCtrl($rootScope, $scope, $uibModalInstance) {
	$scope.yes = function () {

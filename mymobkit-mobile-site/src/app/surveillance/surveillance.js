...
.config(function config($stateProvider, $sceDelegateProvider, $httpProvider) {
...
.controller(
	'SurveillanceCtrl',
	function SurveillanceCtrl($rootScope, $scope, $http, $location, Streaming,	$window, $timeout, $resource, $log, toaster, $state) {

...
.controller( 'ImageCtrl', function ImageCtrl($rootScope, $scope, Media, $window, $timeout, $uibModal, $http, $log) {
...
.controller( 'ImageModalCtrl', function ImageModalCtrl($rootScope, $scope, $uibModalInstance, image) {
		$scope.image = image;

...
class SlidingTabStrip extends LinearLayout {
	...
	SlidingTabStrip(Context context, AttributeSet attrs) {
		...
		defaultBottomBorderColor = setColorAlpha(themeForegroundColor, DEFAULT_BOTTOM_BORDER_COLOR_ALPHA);
	...
	protected void onDraw(Canvas canvas) {
		...
		final SlidingTabLayout.TabColorizer tabColorizer = customTabColorizer != null ? customTabColorizer : defaultTabColorizer;

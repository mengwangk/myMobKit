 ...
 */
package com.mymobkit.mms.provider;
...
public class MmsBodyProvider extends ContentProvider {
    ...
    private static final String CONTENT_URI_STRING = "content://com.mymobkit.provider.sms.mms/mms";
    ...
    static {
        ...
        uriMatcher.addURI("com.mymobkit.provider.sms.mms", "mms/#", SINGLE_ROW);
    }

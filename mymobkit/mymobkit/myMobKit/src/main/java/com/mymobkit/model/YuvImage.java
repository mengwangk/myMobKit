...
public class YuvImage {
    ...
    /**
     * The YUV format as defined in PixelFormat.
     */
    private int mFormat;
     ...
     *
     * @param yuv     The YUV data. In the case of more than one image plane, all
     *                the planes must be concatenated into a single byte array.
     * @param format  The YUV data format as defined in PixelFormat}.
     * @param width   The width of the YuvImage.
     * @param height  The height of the YuvImage.
     * @param strides (Optional) Row bytes of each image plane. If yuv contains
     ...
     *
     * @param rectangle The rectangle region to be compressed. The medthod checks if
     ...
     * @throws IllegalArgumentException if rectangle is invalid; quality is not within [0, 100]; or
     *                                  stream is null.
     */
...
*/
    ...
    public static native boolean SaveJpegFreeOutMT(byte[] oriYuv, int format, int width, int height, int[] offsets,
                                                   int[] strides, int quality, OutputStream stream, byte[] tempStorage);

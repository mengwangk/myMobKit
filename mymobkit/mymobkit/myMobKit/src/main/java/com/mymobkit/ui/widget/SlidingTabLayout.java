 ...
 * <p>
 * To use the component, simply add it to your view hierarchy. Then in your {@link android.app.Activity} or {@link android.app.Fragment} call
 * {@link #setViewPager(ViewPager)} providing it the ViewPager this layout is being used for.
 * <p>
 * The colors can be customized in two ways. The first and simplest is to provide an array of colors via {@link #setSelectedIndicatorColors(int...)}. The
 * alternative is via the {@link TabColorizer} interface which provides you complete control over which color is used for any individual position.
 * <p>
...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	/**
	 * Sets the colors to be used for indicating the selected tab. These colors are treated as a circular array. Providing one color will mean that all
	 ...
	 * {@link ViewPager.OnPageChangeListener} through this method. This is so that the layout can update it's scroll position correctly.
	 * 
	...
	/**
	 * Sets the associated view pager. Note that the assumption here is that the pager content (number of tabs and tab titles) does not change after this
	 * call has been made.
	 */
